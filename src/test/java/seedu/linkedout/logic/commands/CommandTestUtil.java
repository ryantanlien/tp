...
public class CommandTestUtil {
    ...
    public static final String VALID_JOB_AMY = "Site Reliability Engineer";
    public static final String VALID_JOB_BOB = "Developer Relations Associate";
    public static final String VALID_STAGE_AMY = "Technical Interview";
    public static final String VALID_STAGE_BOB = "Job Offer Accepted";
    ...
    //The PREFIX_ADDRESS for the below fields are just placeholders.
    public static final String JOB_DESC_AMY = " " + PREFIX_ADDRESS + VALID_JOB_AMY;
    public static final String JOB_DESC_BOB = " " + PREFIX_ADDRESS + VALID_JOB_BOB;
    public static final String STAGE_DESC_AMY = " " + PREFIX_ADDRESS + VALID_STAGE_AMY;
    public static final String STAGE_DESC_BOB = " " + PREFIX_ADDRESS + VALID_STAGE_BOB;
